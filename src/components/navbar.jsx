...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      <NavControlBtn isOpen={isOpen} setIsOpen={setIsOpen} />
    </div>
  );
}
  ...
  return (
    <>
      <svg
        ...
        className={` ${!isOpen ? "text-black" : "text-white"} z-50 `}
      >
        <path
...
function NavControlBtn({ isOpen, setIsOpen }) {
  function handleNavbar() {
    setIsOpen((isOpen) => !isOpen);
  }
  return (
    <div onClick={handleNavbar} className="z-50 md:hidden">
      {isOpen ? (
        <div>
